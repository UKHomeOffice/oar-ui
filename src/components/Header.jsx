    ...
    <div className="govuk-header__container govuk-width-container">
        ...
        <div className="govuk-header__logo">
            <a href="#" className="govuk-header__link govuk-header__link--homepage">
                <img src={img} width="36" height="32" alt="" className="content"/> 
...
<div className="govuk-label--m">  Operational activity reporting</div>
<div className="govuk-label--s govuk-link govuk-link--no-visited-state" ><a href="#" className="govuk-link govuk-link--no-visited-state" >Activities</a> 
<a href="#" className="govuk-header__link"> CT Referrals</a></div>
</div>
</div>
    </div>
